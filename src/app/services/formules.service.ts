...
export class FormulesService {
  ...
  // }
  separateChildFromParent(childNumbers) {
    let url = this.baseUrl + "formules/separateChildFromParent";
    return this.http
  ...
  getFormulePriceByNumber(formuleNumber) {
    let url =
      this.baseUrl + "formules/PriceByNumber?formuleNumber=" + formuleNumber;
    return this.http.get(url).pipe(map((reponse) => reponse.json()));
  }

  getCurrencyUSDRates() {
    let url =
      "https://v6.exchangerate-api.com/v6/b2e6eed7c40f8ad1bacd456b/latest/USD";

    return this.http.get(url).pipe(map((reponse) => reponse.json()));
  }
  getCurrencyEURORates() {
    let url =
      "https://v6.exchangerate-api.com/v6/b2e6eed7c40f8ad1bacd456b/latest/EUR";
  ...
  updateFormuleWhenPrint(updatedFormule) {
    ...
    return this.http
      .post(url, JSON.stringify(updatedFormule), this.options)
      .pipe(map((res) => res.json()));
  }
  approveFormule(id) {
  ...
  copyFormule(copiedFormule) {
    ...
    return this.http
      .post(url, JSON.stringify(copiedFormule), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  deletePhaseById(phaseToDelete) {
    ...
    return this.http
      .post(url, JSON.stringify(phaseToDelete), this.options)
      .pipe(map((res) => res.json()));
  }
  deleteItemById(itemToDelete) {
    let url = this.baseUrl + "formules/deleteItemById";
    return this.http
      .post(url, JSON.stringify(itemToDelete), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  addPhase(newPhase) {
    ...
    return this.http
      .post(url, JSON.stringify(newPhase), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  addNewPhaseToFormule(newFormulePhase) {
    ...
    return this.http
      .post(url, JSON.stringify(newFormulePhase), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  updateFormule(newFormuleDetails) {
    ...
    return this.http
      .put(url, JSON.stringify(newFormuleDetails), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  updateFormulePhase(phase) {
    ...
    return this.http
      .put(url, JSON.stringify(phase), this.options)
      .pipe(map((res) => res.json()));
  }
  ...
  startFormuleForm(request) {
    ...
    return this.http
      .post(url, JSON.stringify(request), this.options)
      .pipe(map((res) => res.json()));
  }
