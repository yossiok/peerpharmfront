...
export class Procurementservice {
  ...
  changeColor(itemNumber,orderNumber,orderAmount,supplierPrice):Observable<any>{
    let url = this.baseUrl + 'procurementOrderController/changeColor';
    return this.http.post(url, JSON.stringify({itemNumber,orderNumber,orderAmount,supplierPrice}), this.options).pipe(map(res=>res.json()));
  }
