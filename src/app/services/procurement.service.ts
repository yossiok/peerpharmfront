...
export class Procurementservice {
  ...
  startNewCall(skip, limit, isClosed, observer) {
    let url = this.baseUrl + "procurementOrderController/getAllPurchases?skip=" + skip + "&limit=" + limit + "&isClosed=" + isClosed;
  ...
  getPurchasesForComponent(componentN) {
    let url = this.baseUrl + 'procurementOrderController/getPurchasesForComponent?componentNumber=' + componentN
